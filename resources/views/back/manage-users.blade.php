        ...
        <div class="templatemo-content-container">
          ...
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="media margin-bottom-30">
                <div class="media-left padding-right-25">
                  <a href="#">
                    <img class="media-object img-circle templatemo-img-bordered" src="back/images/person.jpg" alt="Sunset">
                  </a>
                </div>
            ...
            <div class="templatemo-content-widget white-bg col-1 text-center templatemo-position-relative">
              <i class="fa fa-times"></i>
              <img src="back/images/person.jpg" alt="Bicycle" class="img-circle img-thumbnail margin-bottom-30">
            ...
            <div class="templatemo-content-widget white-bg col-1 templatemo-position-relative templatemo-content-img-bg">
              <img src="back/images/sunset-big.jpg" alt="Sunset" class="img-responsive content-bg-img">
